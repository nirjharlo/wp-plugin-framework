...
if ( ! class_exists( 'NirjharLo\\WP_Plugin_Framework\\Src\\Cpt' ) ) {
	...
	class Cpt {
		...
		private function labels() {
				...
				$labels = array(
					'name'               => _x( 'Example', 'Post Type General Name', 'textdomain' ),
					...
					'all_items'          => __( 'Example', 'textdomain' ),
					'view_item'          => __( 'Example', 'textdomain' ),
					'add_new_item'       => __( 'Example', 'textdomain' ),
					'add_new'            => __( 'Example', 'textdomain' ),
					'edit_item'          => __( 'Example', 'textdomain' ),
					'update_item'        => __( 'Example', 'textdomain' ),
					'search_items'       => __( 'Example', 'textdomain' ),
					'not_found'          => __( 'Example', 'textdomain' ),
					'not_found_in_trash' => __( 'Example', 'textdomain' ),
				);
		...
		private function args( $labels ) {
			...
			$args = array(
				...
				'description'           => __( 'Example', 'textdomain' ),
				'labels'                => $labels,
